...
2. **Read the roadmap**: `rdm roadmap show <slug> --project <PROJECT>` to get the overview and phase list.
...
4. **Read each phase**: `rdm phase show <stem> --roadmap <slug> --project <PROJECT> --format json` for each phase. Collect titles, bodies, and commit SHAs.
