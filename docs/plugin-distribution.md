...
- `.claude/workflows/rdm-wf-backlog.js` — stamped block generated by `scripts/gen-workflow-backlog.sh` from `.claude/workflows/lib/backlog.mjs` (verified byte-identical by `scripts/verify-workflow-backlog.sh`); the surrounding code stays hand-maintained
- `.claude/workflows/rdm-wf-document.js` — stamped block generated by `scripts/gen-workflow-document.sh` from `.claude/workflows/lib/document.mjs` (verified byte-identical by `scripts/verify-workflow-document.sh`); the surrounding code stays hand-maintained
