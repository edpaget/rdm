...
When you hand-edit `rdm-wf-review-refute-fix.js`'s trailing driver code in a way that breaks its structural contract (which should not happen), `scripts/verify-workflow-review-outcome.sh` turns red. Restore the file from git.
