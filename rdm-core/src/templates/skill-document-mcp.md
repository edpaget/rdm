...
2. **Read the roadmap**: use `rdm_roadmap_show` with `project: {proj_param}, roadmap: "<slug>"` to get the overview and phase list.
...
4. **Read each phase**: use `rdm_phase_show` with `project: {proj_param}, roadmap: "<slug>", phase: "<stem>"` for each phase. Collect titles, bodies, and commit SHAs.
